...
export default function MainLayout({ uiColor, loading }) {
    return (
      <div className="min-h-screen h-fit flex flex-col"
            style={{backgroundColor: uiColor}}>
        {loading&&<LoadingPopup/>} {/* Loading while Signing In. */}
        <div className="header " id='top'>
            <div className="bg-bws-10 text-[#333333] text-4xl text-center font-bold p-5 cursor-default" >My Portfolio</div>
            <nav className="bg-white hover:bg-transparent text-center font-medium flex flex-col justify-around px-10 transition-all shadow-lg min-[360px]:flex-row">
        ...
        <div className="body flex flex-col flex-1">
            <div className="flex flex-1 flex-col items-center justify-center w-full my-5 mx-auto ">
                <div className="bg-white text-black w-10/12 h-full p-10 rounded-md shadow-xl break-words max-[360px]:p-5 ">
                    <Outlet></Outlet>
                </div>
            </div>
        </div>
        <div className="footer bg-[#333333] text-center text-white p-5 ">
            <div className="">
                ...
                <div className="flex justify-around max-[500px]:flex-col items-center max-[350px]:text-sm">
...
const LoadingPopup = () => {
    return(
      <div className="fixed z-50 w-full h-full bg-[#00000000] backdrop-blur-md text-4xl font-bold flex items-center justify-center">Loading...</div>
    )
  }